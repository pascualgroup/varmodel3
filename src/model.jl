...
function do_biting!(t, s, stats, event_dist)
    ...
    # println("infs_transmissibility = $(infs_transmissibility)")
    # println("p_transmit")
    # println("src_active_count = $(src_active_count)")
    # println("p_transmit = $(p_transmit)")
    # println("GI immunity")
    # println("src_host_GI = $(src_host.generalized_immunity)")
    # println("GI reduction")
    # println("p_transmit_reduction_GI = $(p_transmit_reduction_generalized_immunity)")
    # println("Combined")
