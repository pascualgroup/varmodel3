...
function generate_runs(db)
    ...
    for row in 1:size(paramstxt, 1)
        ...
        if calc_summary_statistics_instead_sqlite
        ...
        generalized_immunity_on = paramstxt[row, "generalized_immunity_on"] == "True"
        if generalized_immunity_on
            generalized_immunity_loss_rate = paramstxt[row, "generalized_immunity_loss_rate"]
            generalized_immunity_transmissibility_param = paramstxt[row, "generalized_immunity_transmissibility_param"]
            generalized_immunity_detectability_param = paramstxt[row, "generalized_immunity_detectability_param"]   
            generalized_immunity_detectability_on = paramstxt[row, "generalized_immunity_detectability_on"] == "True"
        else
        ...
        for replicate in 1:N_REPLICATES
            ...
            params = add_params(base_params, (
                ...
                generalized_immunity_on = generalized_immunity_on,
